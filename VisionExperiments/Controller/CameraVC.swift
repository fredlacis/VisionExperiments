...
/// A CameraVC contains all properties necessaries to instatiate a video session
class CameraVC: UIViewController, AVCaptureVideoDataOutputSampleBufferDelegate {
    ...
    /// Initializes a CameraVC
    /// - Parameters:
    ///     - Current MLModel: Model which will be used on the Camera
...
extension CameraVC {
    /// TO DO: Break it on smaller functions
...
extension CameraVC {
    ...
    ///     - confidence: Percetual of confidence on the guess
    ...
    /// Human bounding box
    /// - Parameters:
    ///     - oberservation: Pose Observation
    /// - Returns: A CGRect
...
extension CameraVC {
    ...
    ///     - sampleBuffer: Sample Bufer format
    ///     - connection: AV capture current connection
...
extension CameraVC {
    ...
    /// Tier 2 - Video output view constraints
